...
function sum(a, b) { //eslint-disable-line
  var sumNum = a + b;
  var sumString = `The sum of ${a} and ${b} is ${sumNum}.`;
...
function multiply(a, b) { //eslint-disable-line
  var sumMultiply = a * b;
  var sumString = `The product of ${a} and ${b} is ${sumMultiply}.`;
  var sumArray = [sumMultiply, sumString];
  return sumArray;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var sumNum = sum(a,b);
  var sumNum2 = sum(sumNum[0],c);
  var sumMultiply = multiply(a,b);
  var sumMultiply2 = multiply(sumMultiply[0],c);
  var sumString1 = `${a} and ${b} and ${c} sum to ${sumNum2[0]}.`;
  var sumString2 = `The product of ${a} and ${b} and ${c} is ${sumMultiply2[0]}.`;
  var sumArray = [sumNum2[0],sumMultiply2[0],sumString1,sumString2];
  return sumArray;
}
