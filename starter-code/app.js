...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var sumNum = sum(a, b)[0];
  sumNum = sum(sumNum, c)[0];
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  //initial total is sum of first 2 numbers
  var total = sum(sumArr[0], sumArr[1])[0];

  //if there are more than 2 numbers, keep adding the total to the next number starting at index 2
  if (sumArr.length > 2) {
